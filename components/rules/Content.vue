...
<template>
	...
	<section class="mt-10">
		...
		<ul class="show-rules">
			...
			<li>
				Extra horses may be added for an additional &#36;1 a model to a maximum
				of 6 models.
			</li>
		</ul>
	</section>
	...
	<section>
		...
		<ul class="show-rules">
			<li>
				This is a 3x5-card show. Standard Region 2 card format will be used.
				Showers need to provide a 3x5 index card for each entry; shower's name
				and horse's name go on one side, and the class number, breed, and gender
				of the horse go on the reverse.
				<RulesModal />
			</li>
			<li>Halters are not recommended for Halter classes.</li>
			<li>
				If you have a question about where a horse will go, please ask the judge
				or showholder.
			</li>
			<li>
				At the judge&apos;s/showholder&apos;s discretion, a shower may be asked
				to moved their entry to another class/division if the judge deems the
				entry incorrectly placed.
			</li>
			<li>
				If a shower chooses to lay their entry down on the table rather than
				place it in a standing position, they give the judge the authority to
				pick up the horse for judging so that they can view the other side of
				the model. The judge must be allowed to pick up such models for judging.
			</li>
			<li>
				Decisions of the judges are final! Please do not question them while
			...
			<li>
				Please do not hover while the judge is judging a class! Likewise, please
				refrain from interrupting the judges while they are judging a class.
			</li>
			<li>
				Do not touch any models other than your own unless you have the specific
				permission of the owner.
			</li>
			<li>
				Anyone using bad behavior or language, or exhibiting poor sportsmanship,
				will be asked to leave the show hall with no refund. The judge's
				decisions are final.
			</li>
			<li>
	...
	<section>
		<UDivider
			id="general-class-information"
			label="General Class Information" />
		<ul class="show-rules">
			<li>
				Classes may be split, combined or canceled, depending upon the number of
	...
	<section>
		...
		<ul class="show-rules">
			<li>
				Documentation for your horses is welcomed and is highly recommended for
				unusual breeds, colors, or coat patterns. Please don&apos;t assume the
				judges know everything there is to know about every breed and color. As
				a courtesy to other showers, please limit the size of your documentation
				to a maximum of 8-1/2 x 11 inches. DO NOT include documentation for
				common breeds, unless the model is showing with an unusual color.
			</li>
		</ul>
	</section>
	<!-- TEAM ENTRIES -->
	<section>
		...
		<ul class="show-rules">
			<li>
				Team entries (mother/daughter, sisters, wife/husband) are considered as
				one entrant unless individual fees are paid for both. Team models may be
				shown under either person’s name or barn name. The team is allowed only
				the individual number of entries per class unless full individual fees
				for each person have been paid.
			</li>
		</ul>
	</section>
	<!-- PROXY SHOWING -->
	<section>
		...
		<ul class="show-rules">
			<li>
				There is a flat fee listed on the entry form for proxy showers. Proxy
				showers are allowed a maximum of 20 horses per day of the show. Table
				space will not be provided and the entry card must show the name of the
				horse owner and the proxy shower.
			</li>
		</ul>
	</section>
	<!-- RAFFLE -->
	...
	<section>
		...
		<ul class="show-rules">
			<li>
				...
				the night before. Please check with me if you want to order and pre-pay
				for your food that way.
			</li>
		</ul>
	</section>
	<!-- SHOW HALL -->
	<section>
		...
		<ul class="show-rules">
			<li>
				The show hall will be locked after the end of the show on Saturday. No
				one will be allowed access until 8AM on Sunday. You may leave your
				possessions overnight at your own risk. Under no circumstances will show
				affiliates or the hotel be held responsible for lost, stolen, or damaged
				property. Please use your best judgment when leaving your things.
				Entrants are responsible for their own property.
			</li>
		</ul>
	</section>
	...
	<section>
		<UDivider
			id="division-definitions"
			label="Division Definitions" />
		<ul class="show-rules">
			<li>
				A Custom is an OF plastic horse that has been repainted, haired, and/or
				modified through resculpting of the body.
			</li>
			<li>
				A Custom Glazed horse is defined as a fired, non-production color. Minor
				facial marking changes are not considered CG. To be considered a
				production run color, a run must consist of more than 1 horse with the
				same color/markings and must be noted as such by the manufacturer.
			</li>
			<li>
				An Artist Resin is defined as any artist-designed and released, or
				artist-made and released sculpture with no specific number of models in
				the run. Repainted factory run chinas and resins, such as the Breyer
				releases, Animal Artistry and Northlights, will show in this division.
			</li>
			<li>
				A China is defined as a fired, production color. To be considered a
				production run color, a run must consist of more than 1 horse with the
				same color/markings and must be noted as such by the manufacturer.
			</li>
			<li>
				The Kids Division is open to anyone 12-years-old and under. Entrants in
				the Kids Division may also show under Novice.
			</li>
			<li>
				The Novice Division is open to anyone who has shown in fewer than 5
				previous model horse shows. There is no age criteria.
			</li>
		</ul>
	</section>
	<!-- JUDGING CRITERIA -->
	<section>
		...
		<ul class="show-rules">
			<li>
				Breed Classes: Best Representative of the Breed based on ABCs (Anatomy,
				Biomechanics and Conformation) and Workmanship.
			</li>
			<li>
				Workmanship Classes: Horses will be judged on the quality of the prep
				work and the paint job and the overall finish or glaze. The quality of
				the sculpture and the ABCs of the sculpture will not be judged.
			</li>
			<li>
				Collectibility Classes: Horses will be judged only on their condition
				and rarity. Showers are encourgaed to provide as much information on
				each model as they can on an additional 3X5 card, since there are a lot
				of chinas out there, some of them exceptionally rare. Other
				documentation is also welcome.
			</li>
			<li>
				Solid horse class entries will have no stockings above the knee or hock,
				or anywhere else on the body; face markings are allowed. Entries with
				any other coat colors will show in Color horse class.
			</li>
			<li>
				The Kids Division is open to anyone 12-years-old and under. Entrants in
				the Kids Division may also show under Novice.
			...
			<li>
				...
				<ul>
					<li>
						Correctness of ABC's — that is, anatomy, biomechanics and
						conformation
					</li>
					<li>
						Ability of model to perform accurately and safely the activity
						presented.
					</li>
					<li>Suitability and fit of tack.</li>
					<li>Accuracy and presentation of entry, including documentation.</li>
				</ul>
			</li>
		</ul>
		<MainInfoBox>
			...
			recommended that documentation be included on all performance entries, and
			that the entrant never assume the judge will know what your intentions
			are. Western and English Pleasure classes are open to ALL breeds and each
			entry will be judged based on that entries' breed standards.
		</MainInfoBox>
	</section>
	<!-- BREED GUIDELINES -->
